...
@nand.on_message(filters.command("clearsudo") & filters.user(OWNER_ID))
async def clear_sudo(client, message: Message):
    SUDOERS.clear()
    await message.reply_text("✅ All sudo users removed.")
